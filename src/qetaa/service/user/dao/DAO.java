package qetaa.service.user.dao;
...
public class DAO {
	...
	@PersistenceContext(unitName = "QetaaUserPU")
	...
	public <T> List<T> getConditionOrdered(Class<T> klass, String columnName, Object val, String orderColumn) {
		Query q = em.createQuery("SELECT b FROM " + klass.getSimpleName() + " b WHERE b." + columnName + " = :value order by b." + orderColumn);
		this.setParameter(q, "value", val);
		return q.getResultList();
	}
